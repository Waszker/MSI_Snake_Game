...
public final class Generation
{
	...
	/**
	 * <p>Creates and initializes snakes population of given size.</p>
	 * @param populationSize number of snakes in population
	 */
	...
	/**
	 * <p>Removes worse half of snakes, performs crosses and mutations to fill population.</p>
	 */
